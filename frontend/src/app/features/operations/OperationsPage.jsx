...
export function OperationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <QueueSection title="Multi-device keys" description="User keys bound to more than one active device." icon={Smartphone} count={devices.length}>
        {devices.length ? (
          <div className="overflow-x-auto">
            <table className="w-full min-w-[520px] text-left text-sm">
              <thead><tr className={`border-b ${tableBorder}`}><th className="p-3">Key ID</th><th className="p-3">User ID</th><th className="p-3">Active devices</th></tr></thead>
        ...
        ) : <EmptyState icon={Smartphone} title="No shared keys detected" description="All active user keys are within the expected device binding." />}
      </QueueSection>
